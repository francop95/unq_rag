...
# Carpetas de raw_data que NO se ingestan. `old/` guarda los documentos que
# fueron reemplazados: siguen ahí para poder consultarlos, pero indexarlos
# duplicaría contenido que ya está cubierto por sus versiones nuevas.
